...
void ImageCanvas::adjustScrollBars()
{
    ...
    {
        float_t posHeightRel = static_cast<float_t> (mPos.y()/imSize.height());  //Relation Mauspos to Height of Image
    ...
    {
        float_t posWidthRel = static_cast<float_t> (mPos.x()/imSize.width()); ////Relation Mauspos to Width of Image
